  ...
  var q = function(g, t) {
        ...
        (function() {
          ...
          if (null === b.style.transform) {
            var a = ["Webkit", "Moz", "ms"],
              d;
            for (d in a)
              if (void 0 !== b.style[a[d] + "Transform"])
    ...
    if (0 < k.length) {
      ...
      if (b.options.wrapper && !b.options.wrapper.nodeType)
        if ((k = document.querySelector(b.options.wrapper)))
          b.options.wrapper = k;
        else {
          console.warn(
      ...
      var B = function() {
          ...
          for (f = 0; f < b.elems.length; f++) {
            var a = b.elems[f],
              ...
              z = b.options.wrapper
                ? b.options.wrapper.scrollTop
                : window.pageYOffset ||
                  document.documentElement.scrollTop ||
                  document.body.scrollTop;
            b.options.relativeToWrapper &&
              (z =
                (window.pageYOffset ||
                  document.documentElement.scrollTop ||
                  document.body.scrollTop) - b.options.wrapper.offsetTop);
            var m = b.options.vertical ? (d || b.options.center ? z : 0) : 0,
              r = b.options.horizontal
                ? d || b.options.center
                  ? b.options.wrapper
                    ? b.options.wrapper.scrollLeft
                    : window.pageXOffset ||
            ...
            a = a.style.cssText;
            d = "";
            if ((r = /transform\s*:/i.exec(a)))
              (d = a.slice(r.index)),
                (d = (r = d.indexOf(";"))
                  ? " " + d.slice(11, r).replace(/\s/g, "")
          ...
          b.options.relativeToWrapper &&
            (l =
              ((
                ...
                document.body.parentNode ||
                document.body
              ).scrollTop || window.pageYOffset) - b.options.wrapper.offsetTop);
          return (c != l && b.options.vertical) ||
            (a != n && b.options.horizontal)
            ? !0
            : !1;
        },
        ...
        h = function() {
          ...
          (b.options.wrapper ? b.options.wrapper : window).removeEventListener(
            "scroll",
            h
          );
          (b.options.wrapper
        ...
        C = function() {
          D() && !1 === w
            ...
            : ((p = null),
              ...
              (b.options.wrapper ? b.options.wrapper : window).addEventListener(
                "scroll",
                h,
                x ? { passive: !0 } : !1
              ),
        ...
        I = function() {
          for (var f, a = 0; a < b.elems.length; a++) {
            ...
            e = -1 != e.indexOf("y") ? n : 0;
            f = H(
              (f + g - c[a].left + v) / (c[a].width + v),
              (d + e - c[a].top + u) / (c[a].height + u),
              c[a].speed,
              c[a].verticalSpeed,
              c[a].horizontalSpeed
            );
            ...
            null !== c[a].min &&
              (b.options.vertical &&
                !b.options.horizontal &&
                (e = e <= c[a].min ? c[a].min : e),
              b.options.horizontal &&
                !b.options.vertical &&
                (d = d <= c[a].min ? c[a].min : d));
            null != c[a].minY && (e = e <= c[a].minY ? c[a].minY : e);
            null != c[a].minX && (d = d <= c[a].minX ? c[a].minX : d);
            null !== c[a].max &&
              (b.options.vertical &&
                !b.options.horizontal &&
                (e = e >= c[a].max ? c[a].max : e),
              b.options.horizontal &&
                !b.options.vertical &&
                (d = d >= c[a].max ? c[a].max : d));
